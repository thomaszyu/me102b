...
# --- TRAJECTORY MATH (NORMALIZED TIME) ---
...
def evaluate_spline_norm(coeffs, tau, dt):
    ...
    # Position (independent of dt scaling)
...
def move_interp_accel_final(data, segments_per_sec, steps_per_segment):
    ...
    for i in range(len(p_data) - 3):
        ...
        # 2. Spline Generation (Normalized)
        ...
        # 4. Analytical Handoff for next segment
...
def animate_trajectory(pos_history, motor_history, time):
